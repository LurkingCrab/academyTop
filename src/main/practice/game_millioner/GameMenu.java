...
//    }
    ...
    static void printingRules() {
        System.out.println("Правила  игры:\nВ игре 5 вопросов. Каждый последующий вопрос будет немного сложнее предыдущего.\n" +
                ...
                "\n" +
                "Задать вопрос аудитории - залу задают тот же вопрос, что и участнику, и проводится быстрый опрос, чтобы " +
                "показать их ответы. На диаграмме показывается явное преимущество определенного варианта, эта подсказка может быть чрезвычайно полезной. " +
                "Участнику дается возможность согласиться с результатами, полученными от аудитории. Для активации введи \"h\"\n" +
                "\n" +
